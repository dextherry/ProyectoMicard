...
public class ContactoRepository {
    ...
    private ContactoRepository(){
        saveContacto(new Contacto("Brian", "Britto", "Juro", "926298867", "brianbrittojuro@gmail.com", "Av. HackSpace 007","abogado"));
        saveContacto(new Contacto("Richard", "Oruna", "Rodriguez", "4421210", "ricoru@gmail.com", "Av. Wando 1000","doctor"));
    }
