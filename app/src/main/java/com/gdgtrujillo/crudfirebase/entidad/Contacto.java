...
public class Contacto {
    ...
    public Contacto(String nombres, String apellidoPaterno, String apellidoMaterno, String telefono, String email, String direccion, String actividad) {
    ...
    public void setDireccion(String actividad) {
        this.direccion = direccion;
    }
